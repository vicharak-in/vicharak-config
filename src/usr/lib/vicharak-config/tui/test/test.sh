...
__test_checklist() {
    ...
    then
        msgbox "Offered '${VICHARAK_CONFIG_CHECKLIST_STATE_OLD[*]}', selected '${VICHARAK_CONFIG_CHECKLIST_STATE_NEW[*]}'."
    else
        msgbox "User cancelled action."
    fi
}
...
__test_radiolist() {
    ...
    then
        msgbox "Offered '${VICHARAK_CONFIG_RADIOLIST_STATE_OLD[*]}', selected '${VICHARAK_CONFIG_RADIOLIST_STATE_NEW[*]}'."
    else
        msgbox "User cancelled action."
    fi
}
